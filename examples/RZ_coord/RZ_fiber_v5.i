...
[Materials]
  ...
  [./free_energy_s]
    ...
    function  = '(eV_J_conv/m3_micron3_conv)*(Na/molar_vol)*(kb*T*x_C*plog(x_C,tol)
  ...
  [./free_energy_g]
    ...
    function  = '(eV_J_conv/m3_micron3_conv)*(Na/molar_vol)
  ...
  [./free_energy_loc]
    ...
    function = 'h*f_g + (1-h)*f_s + (Na/molar_vol)*(eV_J_conv/m3_micron3_conv)*W*g'
    derivative_order = 2
...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = ./results_v5/RZ_fiber_v5_out
  ...
  [../]
   ...
   [./vector]
     ...
     file_base = ./results_v5/vector_PP/vector
   [../]
[]
