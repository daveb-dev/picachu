...
[Materials]
  ...
  [./c_i]
    ...
    material_property_names = 'h(eta) E_f_vac E_f_i k_b T Va'
  ...
  [./GP_vac]
    ...
    function = '(1-c_sum)*(E_f_vac + k_b*T/Va * plog(1-c_sum,tol))'

    args = 'w_i eta'
    material_property_names = 'c_sum(w_i,eta) E_f_vac k_b T Va'
  ...
  [./GP_i]
    ...
    args = 'w_i eta'
    material_property_names = 'c_i(w_i,eta) c_sum(w_i,eta) E_f_i k_b T Va'
...
[Outputs]
  exodus = true
  csv = true
  file_base = ./results_v2/PFCOM_GPM_v2_out
