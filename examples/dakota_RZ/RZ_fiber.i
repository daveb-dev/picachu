...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = ./results/RZ_fiber_out
  ...
  [../]
   ...
   [./vector]
     ...
     file_base = ./results/vector_PP/vector
   [../]
[]
