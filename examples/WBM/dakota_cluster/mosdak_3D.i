...
[VectorPostprocessors]
  ...
  [./line_3.8]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 3.8'
    end_point   = '0.5 0.5 3.8'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_3.6]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 3.6'
    end_point   = '0.5 0.5 3.6'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_3.4]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 3.4'
    end_point   = '0.5 0.5 3.4'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_3.2]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 3.2'
    end_point   = '0.5 0.5 3.2'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_2.8]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 2.8'
    end_point   = '0.5 0.5 2.8'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_2.6]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 2.6'
    end_point   = '0.5 0.5 2.6'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_2.4]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 2.4'
    end_point   = '0.5 0.5 2.4'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_2.2]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 2.2'
    end_point   = '0.5 0.5 2.2'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_1.8]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 1.8'
    end_point   = '0.5 0.5 1.8'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_1.6]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 1.6'
    end_point   = '0.5 0.5 1.6'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
  ...
  [./line_1.4]
    type = LineValueSampler
    num_points  = 20
    start_point = '0.0 0.0 1.4'
    end_point   = '0.5 0.5 1.4'
    variable    = x_C
    sort_by     = x
    execute_on  = 'INITIAL TIMESTEP_END'
    outputs     = vector
