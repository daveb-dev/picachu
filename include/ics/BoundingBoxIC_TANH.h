...
class BoundingBoxIC_TANH;

template <typename T>
InputParameters validParams();

template <>
InputParameters validParams<BoundingBoxIC_TANH>();

/**
 * BoundingBoxIC_TANH allows setting the initial condition of a value inside and outside of a specified
 ...
 */
class BoundingBoxIC_TANH : public InitialCondition
{
public:
  BoundingBoxIC_TANH(const InputParameters & parameters);
...
protected:
  ...
  /// The value for the interface width
